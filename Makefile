...
# or `make veritas TAGS=install EXTRA_VARS="-e manual_disk_selection=true"` to manually select disks during install
# or `make veritas TAGS=install EXTRA_VARS="-e infoscale_layout=stripe -e infoscale_nstripe=2"` to specify storage layout
